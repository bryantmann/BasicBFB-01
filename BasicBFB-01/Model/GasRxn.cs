...
namespace BasicBFB.Model
{
	static public class GasRxn
	{
		...
		static public Dictionary<string, double> dHrxn = new Dictionary<string, double>
		{
		...
		static public double rateC1(double pCO2, double T)
		{
		...
		static public double rateC2(double pH2O, double T)
		{
			double Tkelvin = T + 273.15;
		...
		static public double rateC3(double pH2, double T)
		{
			double Tkelvin = T + 273.15;
		...
		//		CH4 + H2O  <==>  CO + 3H2 
		static public double rateSMR(double cCH4, double cH2O, double T)
		{
			double Tkelvin = T + 273.15;
		...
		//		CO + H2O  <==>  CO2 + H2
		static public double rateWGS(double cCO, double cCO2, double cH2, double cH2O, double T)
		{
			double Tkelvin = T + 273.15;
